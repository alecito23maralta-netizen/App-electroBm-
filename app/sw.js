...
const CACHE_VERSION = 'bm-app-v25';
const APP_SHELL = [
  'index.html',
  'catalogo.html',
  'style.css?v=25',
  'app.js?v=25',
  'catalogo-publico.js?v=25',
  'config.js?v=25',
  'offline.html',
  'manifest.json',
  'icons/icon-192.png',
  ...
  'vendor/capacitor/capacitor-core.js?v=25',
  'vendor/capacitor/synapse.js?v=25',
  'vendor/capacitor/bridge-alias.js?v=25',
  'vendor/capacitor/filesystem-plugin.js?v=25',
  'vendor/capacitor/share-plugin.js?v=25',
  'vendor/capacitor/app-plugin.js?v=25',
  'vendor/capacitor/local-notifications-plugin.js?v=25'
];
