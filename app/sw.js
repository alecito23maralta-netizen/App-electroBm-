...
const CACHE_VERSION = 'bm-app-v26';
const APP_SHELL = [
  'index.html',
  'catalogo.html',
  'style.css?v=26',
  'app.js?v=26',
  'catalogo-publico.js?v=26',
  'config.js?v=26',
  'offline.html',
  'manifest.json',
  'icons/icon-192.png',
  ...
  'vendor/capacitor/capacitor-core.js?v=26',
  'vendor/capacitor/synapse.js?v=26',
  'vendor/capacitor/bridge-alias.js?v=26',
  'vendor/capacitor/filesystem-plugin.js?v=26',
  'vendor/capacitor/share-plugin.js?v=26',
  'vendor/capacitor/app-plugin.js?v=26',
  'vendor/capacitor/local-notifications-plugin.js?v=26'
];
