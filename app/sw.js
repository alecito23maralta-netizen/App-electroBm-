...
const CACHE_VERSION = 'bm-app-v24';
const APP_SHELL = [
  'index.html',
  'catalogo.html',
  'style.css?v=24',
  'app.js?v=24',
  'catalogo-publico.js?v=24',
  'config.js?v=24',
  'offline.html',
  'manifest.json',
  'icons/icon-192.png',
  ...
  'vendor/capacitor/capacitor-core.js?v=24',
  'vendor/capacitor/synapse.js?v=24',
  'vendor/capacitor/bridge-alias.js?v=24',
  'vendor/capacitor/filesystem-plugin.js?v=24',
  'vendor/capacitor/share-plugin.js?v=24',
  'vendor/capacitor/app-plugin.js?v=24',
  'vendor/capacitor/local-notifications-plugin.js?v=24'
];
