...
const CACHE_VERSION = 'bm-app-v18';
const APP_SHELL = [
  'index.html',
  'catalogo.html',
  'style.css?v=18',
  'app.js?v=18',
  'catalogo-publico.js?v=18',
  'config.js?v=18',
  'offline.html',
  'manifest.json',
  'icons/icon-192.png',
  ...
  'vendor/capacitor/capacitor-core.js?v=18',
  'vendor/capacitor/synapse.js?v=18',
  'vendor/capacitor/bridge-alias.js?v=18',
  'vendor/capacitor/filesystem-plugin.js?v=18',
  'vendor/capacitor/share-plugin.js?v=18',
  'vendor/capacitor/app-plugin.js?v=18',
  'vendor/capacitor/local-notifications-plugin.js?v=18'
];
